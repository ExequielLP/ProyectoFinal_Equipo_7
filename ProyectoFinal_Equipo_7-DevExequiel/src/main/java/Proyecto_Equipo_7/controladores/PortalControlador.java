...
public class PortalControlador {
    ...
    @GetMapping("/filtroProveedores/{id}")
    public String devovlerProveedores(@PathVariable String id, ModelMap modelo,RedirectAttributes redirectAttrs) {

        redirectAttrs.addFlashAttribute("proFiltrado", proveedorServicio.listaProveedorPorRubro(id));
